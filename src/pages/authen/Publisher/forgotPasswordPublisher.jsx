...
import { forgotPasswordPublisher } from "../../../services/publisher/apiPublisherServices";
...
const ForgotPasswordPublisher = () => {
  ...
  const onFinish = async (event) => {
    ...
    try {
      ...
      await forgotPasswordPublisher(userEmail);
...
export default ForgotPasswordPublisher;
