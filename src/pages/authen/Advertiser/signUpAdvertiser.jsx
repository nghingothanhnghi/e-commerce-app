...
import { signUpAdvertiser } from "../../../services//advertiser/apiAdvertiserServices";
...
const SignUpAdvertiser = () => {
  ...
  const onFinish = async (event) => {
    ...
    try {
      ...
      // Use the new signUpAdvertiser function
      const user = await signUpAdvertiser(username, email, password);
              ...
              <Row>
                ...
                <Col md={6} lg={6} className="ps-md-5 border-md-start">
                  ...
                  <div className="form_help_text mt-5">
                    Already have an account? <Link to="/signin/advertiser">Sign In</Link>
                  </div>
                </Col>
              </Row>
            </Card.Body>
