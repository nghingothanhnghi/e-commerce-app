...
import { signInAdvertiser } from "../../../services/advertiser/apiAdvertiserServices";
...
const SignInAdvertiser = () => {
  ...
  const onFinish = async (event) => {
    ...
    try {
      ...
      const user = await signInAdvertiser(email, password);
  ...
  const handleUserTypeSpecificActions = (user) => {
    ...
    switch (user?.userType) {
      case USER_TYPES.ADVERTISER:
        // Additional actions for advertiser user type
        console.log("User is an advertiser");
                ...
                <Row>
                  ...
                  <Col md={6} lg={6} className="ps-md-5 border-md-start">
                    ...
                    <div className="form_help_text mt-5">
                      New to FiMi?{" "}
                      <Link to="/signup/advertiser" className="link-secondary">
                        Sign Up
                      </Link>
                    </div>
                  </Col>
